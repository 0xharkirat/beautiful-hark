...
I had also registered my RSS feed with the [SSW People portal](https://www.ssw.com.au/people), which polls employee blogs every hour or two to surface recent posts. Every time it fetched my feed URL after 60 seconds had passed, that was another write.

---
title: >-
  I added a comment section to my blog in one conversation with AI. Zero
  dependencies.
excerpt: >
...
**One thing the agent did before writing any code:** it created a separate Git worktree for this task. I wrote about [why I use Git worktrees](https://harksingh.com/posts/git-worktrees-for-dummies) in a previous post. The short version is that each task gets its own isolated folder and branch, so I can work on something else in parallel without anything interfering. I have this rule baked into my agent setup, and it followed it without being reminded.

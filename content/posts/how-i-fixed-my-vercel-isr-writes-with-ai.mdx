...
I had also registered my RSS feed with the [SSW People portal](https://www.ssw.com.au), which polls employee blogs every hour or two to surface recent posts. Every time it fetched my feed URL after 60 seconds had passed, that was another write.
...
I publish a post every few weeks. TinaCMS saves content by committing it to [GitHub](https://github.com). GitHub tells [Vercel](https://vercel.com) to redeploy. The whole site rebuilds fresh on every publish anyway. ISR was completely unnecessary for my setup. I was burning credits on a timer that was solving a problem I did not have.
...
2. TinaCMS commits the file to [GitHub](https://github.com)
